<h1 align="center">
 <img src="https://user-images.githubusercontent.com/45159366/121819639-15781b00-cc43-11eb-849b-be5b59550e55.png">
  <br />
  Chef Guide
</h1>

#### A guide for getting started with Chef including the Tools and Applications that will make you a better and more efficient engineer with Chef.
...
1. [Chef Learning Resources](https://github.com/mikeroyal/Chef-Guide#chef-learning-resources)

2. [Chef Tools and Services](https://github.com/mikeroyal/Chef-Guide#chef-tools-and-services)

3. [DevOps Tools Integration](https://github.com/mikeroyal/Chef-Guide#devops-tools-integration)

4. [Kubernetes](https://github.com/mikeroyal/Chef-Guide#kubernetes)

5. [Docker](https://github.com/mikeroyal/Chef-Guide#docker)

6. [Azure Development](https://github.com/mikeroyal/Chef-Guide#azure-development)

7. [AWS Development](https://github.com/mikeroyal/Chef-Guide#aws-development)

8. [Google Cloud Platform Development](https://github.com/mikeroyal/Chef-Guide#google-cloud-platform-development)

9. [VMware Development](https://github.com/mikeroyal/Chef-Guide#vmware-development)

10. [Cisco Development](https://github.com/mikeroyal/Chef-Guide#cisco-development)


<p align="center">
 <img src="https://user-images.githubusercontent.com/45159366/121819642-18730b80-cc43-11eb-9eab-6a1f21274073.png">
  <br />
</p>

**Chef Continuous Delivery Framework. Source: [Chef](https://www.chef.io/solutions/continuous-delivery)**

 <p align="center">
 <img src="https://user-images.githubusercontent.com/45159366/121819643-19a43880-cc43-11eb-9af4-93dba4ffc15e.png">
  <br />
</p>


# Chef Learning Resources
[Back to the Top](https://github.com/mikeroyal/Chef-Guide#table-of-contents)
...
[Chef Software Training](https://www.chef.io/training)

[Chef Software Learning Tracks](https://learn.chef.io/tracks)

[Top Chef Software Courses on Udemy](https://www.udemy.com/topic/Chef-Software/)

[Chef for the Absolute Beginners - DevOps on Udemy](https://www.udemy.com/course/learn-chef/)

[Chef Essential Training Course on LinkedIn Learning](https://www.linkedin.com/learning/chef-essential-training)

[Using Chef with Azure](https://docs.microsoft.com/en-us/azure/developer/chef/overview)

[Chef Automate on the AWS Cloud: Quick Start Reference](https://docs.aws.amazon.com/quickstart/latest/chef-automate/welcome.html)

[AWS Case Study: Chef](https://aws.amazon.com/solutions/case-studies/chef/)

[Google Cloud Platform | Chef](https://www.chef.io/partners/google-cloud-platform)

# Chef Tools and Services
[Back to the Top](https://github.com/mikeroyal/Chef-Guide#table-of-contents)

[Chef Workstation](https://docs.chef.io/workstation/) is a tool that gives you everything you need to get started with Chef - ad hoc remote execution, remote scanning, configuration tasks, cookbook creation tools as well as robust dependency and testing software - all in one easy-to-install package.

[Chef Infrastructure Management](https://www.chef.io/products/chef-infrastructure-management) is a tool that enables DevOps teams to model and deploy secure and scalable infrastructure automation across any cloud, VM, and/or physical infrastructure.

[Chef Infra agent](https://www.chef.io/products/chef-infra) is a self-updating, self-automating and works well in low bandwidth or remote environments. It also allows Chef to scale up and down as customers’ demands change. Security keys are managed and rotated regularly using [Chef automated cookbooks](https://docs.chef.io/cookbooks/) which allows admins to turn off port access to SSH and WinRM further securing their environments in line with recommendations from industry standards like CIS (Center for Internet Security) benchmarks.

[Chef Compliance](https://www.chef.io/products/chef-compliance) is service that helps enterprises maintain compliance and prevent security incidents across heterogeneous estates while improving speed and efficiency. Chef Compliance makes it easier than ever to maintain and enforce compliance across the enterprise, with standards-based audit and remediation content, easily tuned baselines to adapt to the organization’s needs, and visibility and control across hybrid and multi-cloud environments.

[Chef InSpec](https://www.chef.io/products/chef-inspec) is a tool that provides a language for describing security and compliance rules that can be shared between software engineers, operations, and security engineers. It also includes compliance, security, and other policy requirements become automated tests that can be run against traditional servers, containers, and cloud APIs, ensuring enforced consistent standards in every managed environment, at every stage of development.

[Chef Desktop](https://www.chef.io/products/chef-desktop) is a that allows IT resource managers to automate the deployment, management, and secure maintenance of any large fleet of IT resources such as laptops, desktops, and kiosk workstations from a centralized location. With Chef Desktop, organizations can gain control over IT resources, ease the management burden, and ensure compliance to minimize risk.

[Chef App Delivery](https://www.chef.io/products/chef-app-delivery) is an automation solution that enables companies to apply a technology agnostic and modular approach to defining, packaging and delivering application and infrastructure across on-prem, hybrid and cloud environments. Chef App Delivery frees DevOps teams from technical debt and antiquated processes, enabling them to deliver successful business outcomes across their entire IT estate.

[Chef Habitat](https://www.chef.io/products/chef-habitat) is an open source solution that provides automation capabilities for defining, packaging and delivering applications to almost any environment regardless of operating system or deployment platform.

[Chef Automate](https://www.chef.io/products/chef-automate) is a service that provides a single dashboard and analytics for infrastructure automation, Chef Habitat for application automation, and Chef InSpec for security and compliance automation. It also measurably increases the ability to deliver software quickly, increasing speed and efficiency while decreasing risk.

[AWS OpsWorks for Chef Automate](https://aws.amazon.com/opsworks/chefautomate/) is a tool that provides a fully managed Chef Automate server and suite of automation tools that give you workflow automation for continuous deployment, automated testing for compliance and security, and a user interface that gives you visibility into your nodes and their status.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Chef-Guide/pulls).
